...
export class memoryMigration1641885576244 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`Pictures\` ADD CONSTRAINT \`FK_14720b2966b5d5ad0ccea65f55f\` FOREIGN KEY (\`pinId\`) REFERENCES \`Pins\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    }
