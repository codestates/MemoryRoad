...
const initialState: State | any = {
  ...
  whiteColorUrl: [
    ...
    'https://server.memory-road.net/upload/white_yellowGreen.png',
    'https://server.memory-road.net/upload/white_green.png',
    'https://server.memory-road.net/upload/white_sky.png',
    'https://server.memory-road.net/upload/white_blue.png',
    'https://server.memory-road.net/upload/white_purple.png',
